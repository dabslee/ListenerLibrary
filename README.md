...
*   **Offline Listening (PWA):** Save individual tracks to your device from the track menu ("Save for offline"). ListenerLibrary is a Progressive Web App with a service worker, so saved tracks — and the app itself — remain playable with no internet connection. Manage your saved tracks on the **Downloads** page. Works on mobile Safari (iOS) and other modern browsers; add the site to your home screen for a full-screen, app-like experience.
